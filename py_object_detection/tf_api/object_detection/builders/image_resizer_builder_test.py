...
from py_object_detection.tf_api.object_detection.builders import image_resizer_builder
from py_object_detection.tf_api.object_detection.protos import image_resizer_pb2

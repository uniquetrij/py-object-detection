...
from py_object_detection.tf_api.object_detection import eval_util
from py_object_detection.tf_api.object_detection.core import prefetcher, standard_fields as fields
from py_object_detection.tf_api.object_detection.metrics import coco_evaluation
from py_object_detection.tf_api.object_detection.utils import object_detection_evaluation
...
def _extract_predictions_and_losses(model,
  ...
  prediction_dict = model.observe(preprocessed_image, true_image_shapes)
